...
namespace Common.Core.Controls
{
	...
	public class PopupLayout : ContentView
	{
		...
		/// The content
		/// </summary>
		private Xamarin.Forms.View content;

		/// <summary>
		/// The popup
		/// </summary>
		private Xamarin.Forms.View popup;
		...
		public void ShowPopup(Xamarin.Forms.View popupView)
		{
			this.ShowPopup(
				popupView,
		...
		public void ShowFullScreenPopup(Xamarin.Forms.View popupView)
		{
			this.ShowPopup(
				popupView,
		...
		public void ShowPopup(Xamarin.Forms.View popupView, Constraint xConstraint, Constraint yConstraint, Constraint widthConstraint = null, Constraint heightConstraint = null)
		{
			DismissPopup();
		...
		public void ShowPopup(Xamarin.Forms.View popupView, Xamarin.Forms.View presenter, PopupLocation location, float paddingX = 0, float paddingY = 0)
		{
			DismissPopup();
			this.popup = popupView;
